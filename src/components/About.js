                    ...
                    <div class="container text-center">
                        <div class="row">
                            <div class="col-lg-10 mx-auto">
                                ...
                                <p class="lead mb-5">This app utilises Natural Language Processing Tools (entity extraction, summarization
                                    ), and adopts a
                                    crowd-sourced and community-curated approach (real-time collaboration via live-chat).
                                </p>
